...
public class Boar extends Animal implements HerbivoreAnimal {

    public Boar(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
