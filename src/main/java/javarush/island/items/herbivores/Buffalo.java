...
public class Buffalo extends Animal implements HerbivoreAnimal {

    public Buffalo(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
