...
public class Sheep extends Animal implements HerbivoreAnimal {

    public Sheep(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
