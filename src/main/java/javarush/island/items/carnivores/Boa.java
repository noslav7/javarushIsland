...
public class Boa extends Animal implements CarnivoreAnimal {
    public Boa(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
