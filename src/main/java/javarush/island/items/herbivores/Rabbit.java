...
public class Rabbit extends Animal implements HerbivoreAnimal {
    public Rabbit(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
