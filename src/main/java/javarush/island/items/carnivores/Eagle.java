...
public class Eagle extends Animal implements CarnivoreAnimal {

    public Eagle(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
