...
public class Goat extends Animal implements HerbivoreAnimal {
    public Goat(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
