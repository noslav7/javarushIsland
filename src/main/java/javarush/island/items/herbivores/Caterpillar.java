...
public class Caterpillar extends Animal implements HerbivoreAnimal {

    public Caterpillar(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
