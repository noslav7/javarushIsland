...
public class Deer extends Animal implements HerbivoreAnimal {

    public Deer(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
