...
public class Bear extends Animal implements CarnivoreAnimal {
    public Bear(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
