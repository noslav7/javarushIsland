...
public class Duck extends Animal implements HerbivoreAnimal {
    public Duck(int maxQuantityInCell, int x, int y, String emoji, double weight, int speed, double howMuchCanEat,
